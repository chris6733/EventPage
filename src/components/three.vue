<template>
  <div class="container">
    <div class="eventstatus">
      <h2>5/29 (五) 00:00:00－6/4 (四) 23:59:59</h2>
      <h3>{{ data.text }}</h3>
    </div>
    <div class="eventwrap">
      <div class="boardtop">
        <div class="method">
          採計禮物：
          <br />房屋（小 / 中 / 大）、工人寶寶 <br />1. 主播排名「前 25
          名」送獎金 <br />2. 主播累積「50,000 坪數」升級草屋 <br />3.
          主播累積「200,000 坪數」升級小木屋 <br />4. 主播累積「500,000
          坪數」升級磚房 <br />5. 主播累積「1,000,000 坪數」升級豪宅
        </div>
      </div>
    ...
    <div class="contenttitle">
      <img
        src="https://vmo.17.media/2005-tw-city/static/images/city_rank2.png"
        alt
      />
    </div>
    <div class="searchbar">
