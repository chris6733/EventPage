<template>
  <div class="container">
    <div class="subselect2">
      <div class="sbsel001">
        <div @click="link = '1'" :class="{ active: link == '1' }"></div>
      </div>
      <div class="sbsel002">
        <div @click="link = '2'" :class="{ active: link == '2' }"></div>
      </div>
    </div>

    <template v-if="link == '1'">
      <div class="eventstatus">
        <h2>6/20 19:20:00 - 19:39:59</h2>
        <h3>{{ data.text }}</h3>
      </div>
      <div class="eventwrap">
        <div class="boardtop">
          <div class="method">
            ...
            <br />城市地產王（小 / 中 / 大）、工人寶寶
            <br />
            <br />1. 主播排名「前 20 名」送總榜加分 <br />2. 主播累積「100,000
            坪數」獲得隱藏版建築、 <br />永久個人徽章
          </div>
        </div>
      ...
      <div class="contenttitle">
        <img
          src="https://vmo.17.media/2005-tw-city/static/images/city_rank5.png"
          alt
        />
      </div>
      <div class="searchbar">
    ...
    <template v-else-if="link == '2'">
      ...
      <div class="eventwrap">
        <div class="boardtop">
          <div class="method">
            採計禮物：
            <br />城市地產王（小 / 中 / 大）、工人寶寶 <br />1. 主播排名「前 25
            名」送總榜加分 <br />2. 主播全體累積達指定坪數且符合抽獎資格，
            <br />則有機會抽中獎金。
          </div>
        </div>
        <div class="board-mid1"></div>
...
.round2 {
  ...
  height: 550px;
  display: flex;
  background-image: url(https://vmo.17.media/2005-tw-city/static/images/city_t5_t2_img.png);
...
.round2 > div {
  ...
  background-image: url(https://vmo.17.media/2005-tw-city/static/images/city_t5_t2_img2.png);
  background-repeat: no-repeat;
  align-items: center;
}
