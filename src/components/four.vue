<template>
  <div class="container">
    <div class="eventstatus">
      <h2>6/5 (五) 00:00:00－6/11 (四) 23:59:59</h2>
      <h3>{{ data.text }}</h3>
    </div>
    <div class="eventwrap">
      <div class="boardtop">
        <div class="method">
          ...
          坪數」升級 <br />社區公園 / 17 國小 / 17 藥局 / 17 派出所 <br />3.
          主播累積「60,000 坪數」升級 <br />運動公園 / 17 高中 / 17 診所 / 17
          警察局 <br />4. 主播累積「150,000 坪數」升級 <br />國家公園 / 17 大學
          / 17 醫院 / 17 警政 <br />5. 所有建築皆升級到最低門檻，
          <br />送「靜態個人頁背景」 <br />6. 所有建築皆升級到最高門檻，
          <br />送「動態個人頁背景」
        </div>
      </div>
    ...
    <div class="contenttitle">
      <img
        src="https://vmo.17.media/2005-tw-city/static/images/city_rank3.png"
        alt
      />
    </div>
    <div class="searchbar">
