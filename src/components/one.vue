<template>
  <div>
    <div class="subselect mt-5 mb-5 justify-content-center">
      <div class="sbsel01">
        <div
          class="container"
          @click="link = '1'"
    ...
    <template v-if="link == '1'">
      <div class="container">
        <div class="eventstatus">
          <h2>5/22 18:00:00－6/20 21:00:00</h2>
          <h3>{{ data.text }}</h3>
        </div>
        ...
        <div class="eventwrap">
          <div class="boardtop">
            <div class="method">
              採計禮物：
              <br />土地、房屋、17 小鎮、17 商店、城市地產王、工人 <br />寶寶
              <br />
              <br />1. 主播排名「前 20 名」，獲得總榜大獎。 <br />2.
              冠軍獎勵價值 30 萬。
            </div>
          </div>
        ...
        <div class="contenttitle">
          <img
            src="https://vmo.17.media/2005-tw-city/static/images/city_rank0.png"
            alt
          />
        </div>
          ...
          >
            ...
            <div class="avatar">
              <img
                ...
                "
                :alt="person.userInfo.diaplayName"
              />
    ...
    <template v-else-if="link == '2'">
      <div class="container">
        <div class="eventstatus">
          <h2>6/10 18:00:00－6/20 21:00:00</h2>
          <h3>{{ data.text }}</h3>
        </div>
    ...
    <template v-else-if="link == '3'">
      <div class="contenttitle">
        <img
          src="https://storage.googleapis.com/media17-prod-web-assets/campaign/2005-tw-city/3cef014a-612e-4728-a501-5e58b1ab575f"
          alt
        />
      </div>
      ...
      <div class="eventpic">
        <img
          src="https://storage.googleapis.com/media17-prod-web-assets/campaign/2005-tw-city/13f41f9c-ec30-4583-8b04-7cccd9667101"
          alt="總榜大獎"
        />
      </div>
    </template>
